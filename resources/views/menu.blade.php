...
@section('content')
      ...
      <!-- //inner banner -->
                     	...
                     	<div class="products" style="padding-top: 0%; padding-left:10%;">	 
                        <div class="container">
                ...
                <div class="col-lg-6 col-lg-6 product-grids" data-menu-section>

                    <!-- Item starts -->

                <div class="row menu-item position-relative">
                        <div class="col-3 p-0 position-relative">
                            <img class="lazyOwl" src="{{ asset('/images/dish_img/')}}/{{ $dish->dish_image }}" style="height: 100px; width:130px;" title="Our latest gallery" alt="">
...
<!-- end modal -->
        ...
        <div class="side-navbar" id="sidebar" class="active">
