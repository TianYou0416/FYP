...
<link href="css/font-awesome.css" rel="stylesheet"> <!-- font-awesome icons --> <link href="{{ asset('/') }}FrontEndSourceFile/css/bootstrap.css" type="text/css" rel="stylesheet" media="all">
...
<style>
    .counter-container span{
        ...
        right: 80px;
                ...
                @php($cartItem)
                <div class="counter-container"><a href="/cart/show"><img src="{{asset('images/cartButton.png')}}" width="50" height="45" alt="" type="button" onClick="location.href='{{route('cart_show')}}'" > <span id="counter">{{   $cartItem  }} </span></a></div> 
                <!-- search button -->
